...
export const createComment = ({post, newComment, auth, socket}) => async(dispatch) =>{
    ...
    try {
        ...
        const msg ={
            ...
            text: newComment.reply ? 'mentioned you in comment.' : 'commented on your post.',
            recipients: newComment.reply ? [newComment.tag._id] : [post.user._id],
            url: `/post/${res.data.newComment._id}`,
...
export const deleteComment = ({post, auth, comment, socket}) => async (dispatch) =>{
    ...
    try {
        ...
        const msg ={
            id: item._id,
            text: comment.reply ? 'mentioned you in comment.' : 'commented on your post.',
